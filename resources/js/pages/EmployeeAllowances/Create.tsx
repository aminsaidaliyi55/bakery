...
const Create: React.FC<Props> = ({ employees, bakeries }) => {
    ...
    const handleSubmit = (e: FormEvent) => {
        ...
        router.post('/employee-allowances', form, {
            onSuccess: () => alert('Allowance recorded successfully!'),
    ...
    return (
        <AppLayout>
            <form onSubmit={handleSubmit} className="max-w-md mx-auto p-4 bg-white rounded shadow">
                <h1 className="text-xl font-bold mb-4">Add Daily Employee Allowance</h1>
                ...
                <div className="mb-3">
                    <label className="block mb-1">Allowance Date</label>
                    <input
                        type="date"
                        name="allowance_date"
                        ...
                        className="w-full border rounded p-2"
                    />
                    {errors.allowance_date && <p className="text-red-600">{errors.allowance_date[0]}</p>}
                </div>
