...
const Edit: React.FC<Props> = ({ purchase, suppliers, rawMaterials, bakeries }) => {
    const { data, setData, put, processing, errors } = useForm({
        supplier_id: purchase.supplier_id,
        raw_material_id: purchase.raw_material_id,
        bakery_id: purchase.bakery_id,
    ...
    return (
        <AppLayout title={`Edit Purchase #${purchase.id}`}>
            <Head title={`Edit Purchase #${purchase.id}`} />
